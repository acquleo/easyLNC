...
namespace easyLNC.ScreenCapture.WGC
{
    ...
    public class DXGIScreenCaptureSessionHandler : IScreenCaptureHandler
    {
        ...
        public DXGIScreenCaptureSessionHandler()
        {
        ...
        public bool Begin(ScreenInfo screen, [NotNullWhen(true)] out IScreenCapture screenCapture)
        {
            try
            {
                ...
                lock (lockObj)
                {
                    ...
                    session = new DxgiScreenCapture(screen, device);
    ...
    internal class WindowsCaptureSessionInfo
    {
        ...
        public DxgiScreenCapture Session { get; set; }
        public WindowsCaptureSessionInfo(DxgiScreenCapture session)
        {
            Session = session;
        }
