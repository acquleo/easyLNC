...
namespace easyLNC.Helper.Direct3D11
{
    public static class Direct3D11Helper
    {
        ...
        public static SharpDX.Direct3D11.Device CreateDevice()
        {
            ...
            {
                using (Adapter adapter = factory.Adapters1.First())
                {
                    var d3dDevice = new SharpDX.Direct3D11.Device(adapter, DeviceCreationFlags.BgraSupport);
